...
registerCounterButton("ex1-wlfBtn", cnt => `withLatestFrom(ReplaySubject) [${cnt}]`, ex1wlf$);
ex1Base$
...
registerCounterButton("ex2-wlfBtn", cnt => `withLatestFrom(ReplaySubject) [${cnt}]`, ex2wlf$);
ex2Base$
